    ...
    <div>
      ...
      <div className='footer m-auto overflow-x-hidden'>
        ...
        <div className='m-auto w-[85%] flex flex-col items-center gap-[48px] sm:flex-row sm:gap-0  sm:justify-between'>
          ...
          <div className='flex flex-col items-start gap-[24px]' data-aos="zoom-out-left" data-aos-duration="1250">
        ...
        <div className='h-[64px] flex justify-center items-center'>
          <p className='text-[#3D3D3D]' data-aos="flip-down" data-aos-duration="1250">© Copyright Rimel 2022. All right reserved</p>
        </div>
